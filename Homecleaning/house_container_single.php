...
<body>
  ...
  <main>
    ...
    <button class="subcategory-btn">House Container Single</button>
    <div class="services-container">
      <div class="service-grid">
        <div class="service-card">
          ...
          <div class="service-content">
            <h3>Basic Cleaning – 1 Cleaner</h3>
        ...
        <div class="service-card">
          ...
          <div class="service-content">
            <h3>Standard Cleaning – 1 Cleaners</h3>
      ...
      <div class="service-grid">
        <div class="service-card wide">
          ...
          <div class="service-content">
            <h3>Deep Cleaning – 1 Cleaners</h3>
