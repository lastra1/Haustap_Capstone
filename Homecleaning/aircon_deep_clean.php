...
<head>
  ...
  <link rel="stylesheet" href="css/aircon-deep-clean.css">
...
<body>
  ...
  <main>
    ...
    <div class="tabs">
      <span class="tab">Home cleaning</span>
      <span class="tab">AC cleaning</span>
      <span class="tab active">AC Deep Cleaning (Chemical Cleaning)</span>
    </div>
    <div class="services-container">
      <div class="service-card">
        <input type="radio" name="service" class="service-radio" id="window-1">
        <label for="window-1" class="radio-label"></label>
        <div class="service-title">Window Type (0.5 HP – 1.5 HP)</div>
      ...
      <div class="service-card">
        ...
        <div class="service-title">Split Type (0.5 HP – 1.5 HP)</div>
        <div class="service-price">₱1,500/unit</div>
        <ul>
          <li>Full disassembly of unit</li>
          <li>Cleaning of evaporator coil & condenser</li>
      ...
      <div class="service-card">
        ...
        <div class="service-title">Window Type (2.0 HP – 2.5 HP)</div>
      ...
      <div class="service-card">
        ...
        <div class="service-title">Split Type (2.0 HP – 2.5 HP)</div>
        <div class="service-price">₱1,800/unit</div>
        <ul>
          <li>Full disassembly of unit</li>
          <li>Cleaning of evaporator coil & condenser</li>
