...
<<<<<<< Updated upstream
        ...
        <div class="table-footer">
          ...
          <div class="summary">
            <span id="totalClients">Total Clients: 0</span>
            <span id="totalActive">Active: 0</span>
            <span id="totalInactive">Inactive: 0</span>
  ...
  <script>
    ...
    (function(){
      ...
      function updateSummaryCounts(){
        ...
        let total = 0, active = 0, inactive = 0, suspend = 0;
        rows.forEach(row => {
