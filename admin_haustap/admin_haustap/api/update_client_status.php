<?php
// Simple endpoint to update client status or delete client records stored in storage/data/clients.json
...
if (!$store || !is_file($store)) {
  ...
  echo json_encode(['success' => false, 'error' => 'Clients store not found']);
  exit;
}
