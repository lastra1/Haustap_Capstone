...
<body>
  ...
  <main>
    ...
    <button class="subcategory-btn">Villa Larger</button>
    <div class="services-container">
      <div class="service-grid">
        <div class="service-card">
          ...
          <div class="service-content">
            <h3>Basic Cleaning – 4 Cleaners</h3>
        ...
        <div class="service-card">
          ...
          <div class="service-content">
            <h3>Standard Cleaning – 5 Cleaners</h3>
      ...
      <div class="service-grid">
        <div class="service-card wide">
          ...
          <div class="service-content">
            <h3>Deep Cleaning – 6 Cleaners</h3>
            <div class="price">₱20,000</div>
            <p><strong>Inclusions:</strong></p>
            <ul>
              <li>All Standard tasks</li>
              <li>Tile scrubbing & grout cleaninge</li>
