...
export default function IndoorServicesScreen() {
  ...
  const services = [
    ...
    { title: "Pest Control", route: "/client-side/indoor-services/pestControl" },
  ] as const;

  return (
    <View style={styles.container}>
      <ScrollView>
        <Text style={styles.header}>Indoor Services</Text>
