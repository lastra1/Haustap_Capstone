// Web-specific booking location component
// This component is completely separate from the native version to avoid react-native-maps imports
...
export default function BookingLocation() {
  ...
  const pinLocation = "14.3589, 121.0583";
  const [pinAddress] = useState<string | null>(null);
